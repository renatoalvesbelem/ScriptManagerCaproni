...
public class PanelCheckBox extends JPanel {
    ...
    public void createCheckBox(@SuppressWarnings("deprecation") String folder) {
        ...
        int y = 0;
        try {
            for (@SuppressWarnings("deprecation") String element : scriptFolderControl.getSystemDirectoriesAndName().values()) {
    ...
    ArrayList<String> getListCheckBoxSelected() {
