...
public class CaproniConfigurationView extends JFrame {
    ...
    public CaproniConfigurationView() {
        ...
        btSalvar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                salvarArquivo(caproniConfigurationControl, txCaproniPath, txScriptPath);
            }
        });
        ...
        btChooseScriptFolder.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                preencheCaminhoPath(txScriptPath);
            }
        });
    ...
    private void salvarArquivo(CaproniConfigurationControl caproniConfigurationControl, JTextField txCaproniPath, JTextField txScriptPath) {
